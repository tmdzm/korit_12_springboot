...
public class CardatabaseApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		appUserRepository.save(new AppUser("user","$2a$12$HFggwalNZTDPzdgnWtMW0evUaFe.pKQu6LrsOun16nmT7LXMvQT8O","User"));
		appUserRepository.save(new AppUser("admin","$2a$12$C7sizbU7Qgewp8xsCscZxO5bqp5Z2ViXHSxZbYizswrA5yxuQ/0cy","Admin"));
	}
}
